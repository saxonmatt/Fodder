    ...
    public class CampaignScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (!loading)
            {
                ...
                if(texPreview!=null) spriteBatch.Draw(texPreview, new Vector2(spriteBatch.GraphicsDevice.Viewport.Width, spriteBatch.GraphicsDevice.Viewport.Height) / 2, null, Color.White * scenarioAlpha * TransitionAlpha, 0f, new Vector2(texPreview.Width,texPreview.Height)/2, 1f, SpriteEffects.None,1);
